...
have you every been hit with the rate limit on chatgpt, recently they even stopped free users from selecting their preferred models. guess it makes that less confusing for the people who know nothing about, even though, having no way to change it, makes it infuriating (especially for openianated people like me). 
...
:::important
some people prefer chatgpt's output for certain tasks ¯\\\_(ツ)\_/¯ over the other models. to me chatgpt's output always felt like vanilla (even with system prompts). if you ask me what's wrong with vanilla, i don't want to argue with you, just keep your vanilla and leave me alone.
:::
...
:::tip
make sure to select the model and ground with google search for grounded results.
...
the strength of grok3 comes from the **realtime access to the x (previously twitter) dataset** and the brilliant ai/system engineers that tesla/spacex[^2] has access to. i don't want to bring the name of the man in here since he's more of a political figure now, dragging this technologies through the mud of politics. i'd just say that the model is solid and it works great for most of the tasks. i actually **prefer to do research in this** rather than any other model because of its capabilities in a functionality called _deep search_.
...
we need to be increasingly caucious and selective about the data we consume nowadays cause anything and everything is available nowadays and it's really hard to verify the validity of the information.

here are some not so solid steps you can follow to keep afloat in this turbulant times
:::
...
for better or for worse, i'm constantly exploring the options available in this space and i have some picks that i want you to know about. keep in mind that, priority is given to open source project and if a closed source project is mentioned anyways then there is a high chance i couldn't find any better alternatives in open source or it's just that much awesome.

### open source software
open source software is awesome man! here are some of the best projects i've witnessed. 

:::note
i haven't mentioned some legends of open source legends (like nodejs, ffmpeg, linux) just to keep this short and to introduce you to newer simpler things that are completely free.
:::
...
#### mojo
[mojo](https://www.modular.com/mojo) is like a new kid in town. but fear not! the team behind it is awesome! (but the ai generated images and stuff on their site and their licensing really ticks me off). but this is a very good python like language that has a good potential to become an alternative to cpp, cuda and all kinds of gpu programming. keep a lookout.
